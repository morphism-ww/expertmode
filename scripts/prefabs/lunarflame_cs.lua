...
local COLOUR_ENVELOPE_NAME2 = "lunarflame_colourenvelope2"
local SCALE_ENVELOPE_NAME2 = "lunarflame_scaleenvelope2"
...
local function fn()
    ...
    local sphere_emitter = CreateSphereEmitter(4)
...
return Prefab("lunarflame_cs", fn, assets)
