...
local function OnAttacked(inst, data)
	...
	if data.redirected or attacker==nil then
		return
	end

	if data.weapon~=nil and (data.weapon:HasTag("projectile") or 
		(data.weapon.components.weapon ~= nil and data.weapon.components.weapon.projectile ~= nil)) then
		return
	end

	if not (attacker.components.health ~= nil and attacker.components.health:IsDead()) and
...
return Prefab("newcs_dragoon", fn, assets, prefabs)