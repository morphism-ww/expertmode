...
local function CalcSanityAura(inst, observer)
    ...
    return lightRadius > 0 and observer:IsNear(inst, .5 * lightRadius) and TUNING.SANITYAURA_MED or 0
end
...
local function fn()
    ...
    inst.AnimState:SetBuild("lunar_torch")
...
return Prefab("lunarlight", fn, assets, prefabs),
    MakePlacer("lunarlight_placer", "lunar_torch", "lunar_torch", "idle")
