...
local function dragonboat_common(inst, boat_data)
    ...
    inst.walksound = "dontstarve/movement/run_marble"
...
local function dragonboat_server(inst, boat_data)
    ...
    inst.components.boatphysics.super=true
...
local function item_base_fn(data)
    ...
    inst.deploy_product = "superboat_body"
...
return Prefab("superboat_body", body_fn, assets, prefabs),
    Prefab("superboat_kit", item_fn, item_assets, item_prefabs),
    MakePlacer("superboat_kit_placer", "boat_yotd", "boat_yotd", "idle_full", true, false, false, nil, nil, nil, nil, 6),
    Prefab("superboat_player_collision", dragonboat_player_collision_fn),
    Prefab("superboat_item_collision", dragonboat_item_collision_fn)
